/*
    ...
    contendo N elementos até obter N valores de apenas um elemento cada um.
    Em seguida, usando a técnica de mesclagem (merge), "remota" o vetor,
...
function mergeSort(vetor){
    ...
    if(vetor.length > 1){
        ...
        // (inclusive) até a posição final (exclusive - a posição final NÂO entra)
