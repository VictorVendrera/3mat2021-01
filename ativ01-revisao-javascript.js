...
*/
estadosN = []
estadosN.unshift(estadosNe[1].nome)
estadosN.splice(2,0,estadosNe[8].nome, estadosNe[5].nome, estadosNe[7].nome, estadosNe[3].nome,estadosNe[4].nome,estadosNe[6].nome, estadosNe[2].nome)
estadosN.push(estadosNe[0].nome)
console.table(estadosN)